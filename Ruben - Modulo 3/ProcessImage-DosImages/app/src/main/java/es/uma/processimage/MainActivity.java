...
public class MainActivity extends AppCompatActivity {
    ...
    public static Bitmap processImage(){
        if(!imageFilePath.matches("")) {
            ...
            FiltroImagen st = new FiltroAzulExecutor();
            switch (optionSelected) {
                case 0:
                    st = new FiltroAzul();
                    break;
                case 1:
                    st = new FiltroAzulThread();
                    break;
                case 2:
                    st = new FiltroAzulExecutor();
                    break;
                case 3:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    st = FiltroMatrizThread.creaFiltroBordes();
                    break;
                case 8:
                    st = FiltroMatrizExecutor.creaFiltroBordes();
                    break;
                case 9:
                    st = FiltroMatriz.creaFiltroEnfoque();
                    break;
                case 10:
                    st = FiltroMatrizThread.creaFiltroEnfoque();
                    break;
                case 11:
                    st = FiltroMatrizExecutor.creaFiltroEnfoque();
                    break;
                case 12:
                    st = FiltroMatriz.creaFiltroMedia();
                    break;
                case 13:
                    st = FiltroMatrizThread.creaFiltroMedia();
                    break;
                case 14:
                    st = FiltroMatrizExecutor.creaFiltroMedia();
                    break;
            }
